...
BASE_DIR = os.getenv('BASE_DIR') or '/omics/groups/OE0532/internal/from_snapshot'
...
def upload_project(project_id, bam_type=""):
   ...
   tracks_dir = os.path.join(BASE_DIR, project_id, "analysis/output/ucsc_tracks/{}".format(bam_type))
