...
subset = ""
if len(sys.argv) >= 5:
    subset = "_{}".format(sys.argv[4])

contrasts = "/icgc/dkfzlsdf/analysis/OE0532/{}/analysis/input/metadata/rpf_density_contrasts{}.tsv".format(project_id, subset)
...
outdir = "/icgc/dkfzlsdf/analysis/OE0532/{}/analysis/output/ext_diricore/{}/psites_CDF/{}".format(project_id, bam_type, aa)
p_plot_dir = "/icgc/dkfzlsdf/analysis/OE0532/{}/analysis/output/figures/ext_diricore/{}/psites_CDF/{}".format(project_id, bam_type, aa)
a_plot_dir = "/icgc/dkfzlsdf/analysis/OE0532/{}/analysis/output/figures/ext_diricore/{}/asites_CDF/{}".format(project_id, bam_type, aa)
e_plot_dir = "/icgc/dkfzlsdf/analysis/OE0532/{}/analysis/output/figures/ext_diricore/{}/esites_CDF/{}".format(project_id, bam_type, aa)
